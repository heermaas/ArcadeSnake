...
class GameOverView(arcade.View):
    def __init__(self, score, party_mode, bgm, apple_count):
        super().__init__()
        self.snake = Snake()
        self.Item_to_eat = Item_To_Eat(self.snake)
        self.score = score
    ...
    def update(self, delta_time):
        if not self.paused and self.snake.is_snake_moving:
            ...
            if self.movement_timer >= self.move_border:
                ...
                except NoValid_Item_To_Eat_PositionError:
...
class NoValid_Item_To_Eat_PositionError(Exception):
    pass
...
class Item_To_Eat:
    ...
    def spawn(self):
        ...
        if valid_positions:
            ...
            raise NoValid_Item_To_Eat_PositionError("No valid position for the Item.")
